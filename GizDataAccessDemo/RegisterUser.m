...
- (IBAction)onRegister:(id)sender {
    switch (self.type) {
        case kRegisterUserTypeNormal:
            [self.gizLogin registerUser:self.textUser.text password:self.textPassword.text];
            break;
        case kRegisterUserTypeEmail:
            [self.gizLogin registerUserByEmail:self.textUser.text password:self.textPassword.text];
            break;
        case kRegisterUserTypePhone:
            [self.gizLogin registerUserByPhoneAndCode:self.textUser.text password:self.textPassword.text code:self.textVerifyCode.text];
            break;
        default:
            break;
    }
...
- (void)gizDataAccessDidRequestSendVerifyCode:(GizDataAccessLogin *)login result:(GizDataAccessErrorCode)result message:(NSString *)message
{
